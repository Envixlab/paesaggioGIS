...
* `Layer di sovrapposizione`: foraging_areas
...
Per la rappresentazione grafica dei risultati si può esportare il vettoriale `foraging_areas_land_cover_dissolved` in formato csv e lavorare con un foglio elettronico oppure utilizzare il plugin di QGIS [DataPlotly](https://www.faunalia.eu/it/dev/dataplotly#il-plugin-dataplotly).
...
* `Vettore`: foraging_areas_land_cover_dissolved
* `Campo X`: Anderson
* `Campo Y`: sup_perc
